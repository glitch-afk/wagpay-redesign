  ...
  return (
    <section className="w-full rounded-lg py-8 px-2 text-center dark:bg-secondaryDark">
      <div className="mx-auto flex w-full flex-col items-center justify-between space-y-5 lg:w-10/12 lg:flex-row lg:space-y-0">
        {/* left */}
        <div className="text-center text-sm text-primaryGray lg:w-4/5 lg:text-left">
        ...
        <div className="flex space-x-4">
          <Button classes={`bg-tertiaryGray`}>Cancel</Button>
          <Button classes={`bg-secondaryGray`}>Select Bridges</Button>
        </div>
      </div>
    </section>
  );
